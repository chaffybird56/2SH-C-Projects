...
//=================Question 2================================
    ...
    void TestQ2_five_same(CuTest *tc) {
...
//=================Question 4================================ 
    ...
    void TestQ4_negative(CuTest *tc) {
...
//=================Question 7================================  
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_five_same);
